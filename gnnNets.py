...
class GNNBase(nn.Module):
    ...
    def _argsparse(self, *args, **kwargs):
        ...
        x, edge_index, batch = x.cuda(), edge_index.cuda(), batch.cuda()
    ...
    def propagate(self, edge_index: Adj, size: Size = None, **kwargs):
        ...
        # Otherwise, run both functions in separation.
            ...
            if self.__explain__:
                ...
                assert out.size(self.node_dim) == edge_mask.size(0), (out.size(self.node_dim), edge_mask.size(0))
